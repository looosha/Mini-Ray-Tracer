...
public:
     ...
     */
    double schlick_approx(double cosine, double refractive_index) const;
     ...
     */
    std::pair<bool, Vector3d> refract(const Vector3d &v, const Vector3d &normal, const double &refractive_index) const;
